      ...
      <div className='lg:w-1/2 w-full p-3'>
            ...
            <form  onSubmit={handlesubmit} className='flex flex-col gap-4 mt-6 p-2'>
              ...
              <div className='mt-3 mb-0'>
                <button className=' rounded-xl w-full bg-yellow-200 py-3 text-center   text-xl hover:bg-#ffb800 hover:scale-100 duration-300'>SignUp</button>
              </div>
              </form>
              ...
              <div className='mt-2 text-xs flex justify-between items-center'>
                ...
                <button type='submit' className='py-2 px-5 bg-white border rounded-xl hover:scale-100 duration-300'>
                  <Link href={'/login'}>
                  Login
                  </Link>
                </button>
